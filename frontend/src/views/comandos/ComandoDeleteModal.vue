            ...
            <div class="bg-white rounded-xl border border-gray-100 max-w-md w-full shadow-2xl relative overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-150">
                ...
                <div class="px-6 pt-6 pb-4 flex items-start justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">Eliminar Plantilla de Comando</h3>
                ...
                <div class="p-6">
                    <p class="text-sm text-gray-600 leading-relaxed">
                        ¿Está absolutamente seguro de que desea eliminar la plantilla de comando 
                        <span class="font-bold text-gray-900">"{{ comando?.nombre }}"</span>? 
                        Los agentes ya no podrán recibir este comando remoto desde el panel de control.
                    </p>
                </div>

                <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-end gap-2.5">
                    <button @click="emit('close')" :disabled="isDeleting"
                        class="px-4 py-2 border border-gray-200 text-gray-700 bg-white rounded-lg hover:bg-gray-100 hover:border-gray-350 transition-all text-xs font-medium cursor-pointer disabled:opacity-50">
                        Cancelar
                    </button>
                    ...
                    <button @click="emit('confirm')" :disabled="isDeleting"
                        ...
                        <span>{{ isDeleting ? 'Eliminando...' : 'Eliminar Comando' }}</span>
                    </button>
                </div>
