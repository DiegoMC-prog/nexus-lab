            ...
            <div
                ...
                <div class="p-6 flex gap-4">
                    ...
                    <div class="space-y-1.5">
                        <h3 class="text-base font-bold text-gray-900">¿Desvincular Curso de la Carrera?</h3>
                        <p class="text-sm text-gray-500 leading-relaxed" v-if="curso">
                            Estás a punto de eliminar la asignación de <span class="font-semibold text-gray-900">{{
                                curso.semestre }}</span> para la carrera <span class="font-semibold text-gray-900">{{
                                curso.carrera }}</span>.
                        </p>
                        <p class="text-xs text-red-500 bg-red-50/50 p-2 rounded-lg border border-red-100/50">
                            ⚠️ Atención: Las materias asociadas a este curso académico perderán su jerarquía
                            estructural.
                        </p>
                    </div>
                </div>
