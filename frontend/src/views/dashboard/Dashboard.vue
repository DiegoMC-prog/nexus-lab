...
<template>
    <div class="p-6 space-y-6 bg-slate-50 min-h-screen">
        ...
        <div v-if="isLoading && !stats" class="flex flex-col items-center justify-center min-h-[70vh] space-y-4">
            ...
            <p class="text-sm font-semibold text-slate-500 animate-pulse">Sincronizando métricas globales de Nexus Lab...</p>
        </div>
        ...
        <template v-else-if="stats">
            ...
            <div v-if="isAdmin" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5">
                <!-- Estaciones -->
                <div class="group bg-gradient-to-br from-indigo-500 to-indigo-600 text-white rounded-2xl p-5 shadow-sm border border-indigo-100 hover:-translate-y-1 hover:shadow-md transition-all duration-300 relative overflow-hidden">
                    ...
                    <div class="mt-4 pt-3 border-t border-white/10 grid grid-cols-2 gap-y-1.5 text-[10px] font-semibold text-indigo-100">
                        ...
                        <div class="flex items-center gap-1 col-span-2">
                            ...
                            <span>{{ safeStats.estaciones.mantenimiento }} Mantenimiento / {{ safeStats.estaciones.desconectadas }} Desc.</span>
                        </div>
                    </div>
                </div>

                <!-- Laboratorios -->
                <div class="group bg-gradient-to-br from-teal-500 to-emerald-600 text-white rounded-2xl p-5 shadow-sm border border-teal-100 hover:-translate-y-1 hover:shadow-md transition-all duration-300 relative overflow-hidden">
                    <div class="absolute right-0 bottom-0 translate-x-3 translate-y-3 opacity-15">
                    ...
                    <div class="mt-4 pt-3 border-t border-white/10 flex items-center gap-4 text-xs font-semibold text-teal-50">
                ...
                <!-- Materias -->
                <div class="group bg-gradient-to-br from-blue-500 to-sky-600 text-white rounded-2xl p-5 shadow-sm border border-blue-100 hover:-translate-y-1 hover:shadow-md transition-all duration-300 relative overflow-hidden">
                    <div class="absolute right-0 bottom-0 translate-x-3 translate-y-3 opacity-15">
                    ...
                    <div class="mt-4 pt-3 border-t border-white/10 text-xs font-semibold text-blue-50 flex items-center gap-1">
                ...
                <!-- Docentes -->
                <div class="group bg-gradient-to-br from-orange-500 to-amber-600 text-white rounded-2xl p-5 shadow-sm border border-orange-100 hover:-translate-y-1 hover:shadow-md transition-all duration-300 relative overflow-hidden">
                    <div class="absolute right-0 bottom-0 translate-x-3 translate-y-3 opacity-15">
                    ...
                    <div class="mt-4 pt-3 border-t border-white/10 text-xs font-semibold text-orange-50 flex items-center gap-1">
                ...
                <!-- Estudiantes -->
                <div class="group bg-gradient-to-br from-rose-500 to-pink-600 text-white rounded-2xl p-5 shadow-sm border border-rose-100 hover:-translate-y-1 hover:shadow-md transition-all duration-300 relative overflow-hidden">
                    <div class="absolute right-0 bottom-0 translate-x-3 translate-y-3 opacity-15">
                    ...
                    <div class="mt-4 pt-3 border-t border-white/10 text-xs font-semibold text-rose-50 flex items-center gap-1">
            ...
            <div v-else-if="isDocente" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <div class="group bg-gradient-to-br from-indigo-500 to-indigo-600 text-white rounded-2xl p-5 shadow-sm border border-indigo-100 hover:-translate-y-1 hover:shadow-md transition-all duration-300 relative overflow-hidden">
                    ...
                    <div class="mt-4 pt-3 border-t border-white/10 text-xs font-semibold text-indigo-50 flex items-center gap-1">
                        <Users class="w-3.5 h-3.5" />
                ...
                <div class="group bg-gradient-to-br from-teal-500 to-emerald-600 text-white rounded-2xl p-5 shadow-sm border border-teal-100 hover:-translate-y-1 hover:shadow-md transition-all duration-300 relative overflow-hidden">
                    ...
                    <div class="mt-4">
                        <h3 class="text-3xl font-black">{{ safeStats.docente_kpis?.laboratorios_asignados_count ?? 0 }}</h3>
                        <p class="text-xs text-teal-100 font-medium mt-1">Laboratorios con Clases</p>
                    </div>
                    <div class="mt-4 pt-3 border-t border-white/10 text-xs font-semibold text-teal-50 flex items-center gap-1">
            ...
            <div v-else-if="isEstudiante" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <!-- Mis Materias -->
                <div class="group bg-gradient-to-br from-purple-500 to-indigo-650 text-white rounded-2xl p-5 shadow-sm border border-purple-100 hover:-translate-y-1 hover:shadow-md transition-all duration-300 relative overflow-hidden">
                    <div class="absolute right-0 bottom-0 translate-x-3 translate-y-3 opacity-15">
                        <BookOpen class="w-24 h-24 text-white" />
                    </div>
                    <div class="flex justify-between items-start">
                    ...
                    <div class="mt-4 pt-3 border-t border-white/10 text-xs font-semibold text-purple-50 flex items-center gap-1">
                        <CheckCircle2 class="w-3.5 h-3.5" />
                ...
                <div class="group bg-gradient-to-br from-emerald-500 to-teal-650 text-white rounded-2xl p-5 shadow-sm border border-emerald-100 hover:-translate-y-1 hover:shadow-md transition-all duration-300 relative overflow-hidden">
                    <div class="absolute right-0 bottom-0 translate-x-3 translate-y-3 opacity-15">
                        <Database class="w-24 h-24 text-white" />
                    </div>
                    <div class="flex justify-between items-start">
                    ...
                    <div class="mt-4">
                        <h3 class="text-3xl font-black">{{ safeStats.estudiante_kpis?.laboratorios_activos_count ?? 0 }}</h3>
                        <p class="text-xs text-emerald-100 font-medium mt-1">Laboratorios Operativos</p>
                    </div>
                    <div class="mt-4 pt-3 border-t border-white/10 text-xs font-semibold text-emerald-50 flex items-center gap-1">
            ...
            <div v-if="isAdmin" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs p-6">
                        <div class="flex items-center justify-between mb-5">
                            ...
                            <span class="text-xs font-bold text-slate-400 uppercase tracking-wider">Monitoreo Físico</span>
                        </div>
                            ...
                            >
                                <div>
                                    <div class="flex items-center justify-between mb-2">
                                        ...
                                        <span class="text-3xs font-semibold px-2 py-0.5 bg-slate-100 text-slate-500 rounded-full border border-slate-150 uppercase tracking-tighter">
                                            {{ lab.pabellon }}
                                        </span>
                                    </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="w-full bg-slate-100 rounded-full h-2 overflow-hidden flex border border-slate-150/50">
                                    ...
                                    <div class="flex justify-between items-center text-[10px] text-slate-400 font-bold">
                                        ...
                                        <span :class="lab.estaciones_count > 0 && (lab.estaciones_activas_count / lab.estaciones_count) >= 0.8 ? 'text-emerald-600' : 'text-amber-600'">
                                            {{ lab.estaciones_count > 0 ? Math.round((lab.estaciones_activas_count / lab.estaciones_count) * 105) / 1.05 : 0 }}%
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs p-6">
                        <div class="flex items-center justify-between mb-5">
                            <div>
                                ...
                                <p class="text-xs text-slate-400 font-medium mt-0.5">Schedules activos hoy ({{ getDayName(new Date().getDay() || 7) }})</p>
                            </div>
                            <span class="text-xs font-bold text-blue-600 bg-blue-50/80 border border-blue-150 px-2.5 py-1 rounded-lg">Hoy</span>
                        </div>
                        ...
                        <div v-if="safeStats.horarios_hoy.length === 0" 
                            ...
                            <p class="text-xs text-slate-450 mt-1 max-w-xs mx-auto">No hay registros de horarios programados para esta jornada académica.</p>
                        </div>
                            ...
                            >
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="p-3 bg-white text-blue-600 border border-slate-150 rounded-xl shrink-0 shadow-3xs flex flex-col items-center justify-center w-14 h-14 font-mono font-black text-xs leading-tight">
                                        ...
                                        <span class="text-[9px] font-bold text-slate-400 mt-0.5">{{ horario.hora_fin }}</span>
                                    </div>
                                ...
                                <div class="flex items-center gap-2 shrink-0 md:self-center">
                                    ...
                                    <div class="w-7 h-7 bg-slate-200 hover:bg-blue-100 hover:text-blue-600 rounded-full flex items-center justify-center text-slate-455 transition-colors pointer-events-none">
                ...
                <div class="space-y-6">
                    <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs p-6 flex flex-col h-full justify-between">
                        <div>
                            <div class="flex items-center justify-between mb-5">
                                <h2 class="text-lg font-bold text-slate-800 flex items-center gap-2">
                                ...
                                <span class="text-xs font-black text-red-600 bg-red-50 border border-red-150 px-2 py-0.5 rounded-full uppercase animate-pulse">
                            ...
                            <div v-if="safeStats.alertas.recientes.length === 0" 
                                ...
                                <p class="text-3xs text-slate-400 mt-1">Todas las estaciones operan dentro de los umbrales estipulados.</p>
                            </div>
                            ...
                            <div v-else class="space-y-4">
                                ...
                                >
                                    <div class="space-y-3">
                                        <div class="flex items-start justify-between">
                                            <div class="flex items-center gap-2">
                                                <div class="p-1.5 bg-red-50 text-red-600 rounded-lg">
                                                    <component :is="getMetricIcon(alerta.configuracion_alerta?.metrica)" class="w-4 h-4" />
                                                </div>
                                                <div>
                                                    <h4 class="font-black text-slate-800 text-xs leading-tight">
                                                        {{ getFriendlyMetricName(alerta.configuracion_alerta?.metrica) }}
                                                    </h4>
                                                    <p class="text-[9px] text-slate-400 font-mono tracking-tighter uppercase mt-0.5">
                                        ...
                                        <!-- Detalles de la PC -->
                                        <div class="bg-white border border-slate-150 rounded-lg p-2.5 text-[11px] space-y-1 font-semibold text-slate-500">
                                            <div class="flex items-center justify-between">
                                                <span>Estación:</span>
                                                <span class="text-slate-900 font-extrabold font-mono">{{ alerta.estacion?.hostname ?? 'N/A' }}</span>
                                            </div>
                                            <div class="flex items-center justify-between">
                                                <span>Dirección IP:</span>
                                                <span class="text-slate-655 font-mono">{{ alerta.estacion?.direccion_ip ?? 'N/A' }}</span>
                                            </div>
            ...
            <div v-else :class="isDocente ? 'grid grid-cols-1 lg:grid-cols-2 gap-6' : 'max-w-4xl mx-auto w-full'">
                ...
                <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs p-6 space-y-5">
                    <div class="flex items-center justify-between pb-2 border-b border-slate-100">
                        ...
                        <span class="text-xs font-black text-blue-600 bg-blue-50 border border-blue-150 px-2.5 py-1 rounded-lg">Hoy</span>
                    </div>
                    ...
                    <div v-if="safeStats.horarios_hoy.length === 0" 
                        ...
                        <p class="text-xs text-slate-400 mt-1 max-w-xs mx-auto">No tienes registros de horarios agendados para la jornada de hoy.</p>
                    </div>
                ...
                <div v-if="isDocente" class="bg-white rounded-2xl border border-slate-200/80 shadow-xs p-6 space-y-5">
                    <div class="flex items-center justify-between pb-2 border-b border-slate-100">
                        ...
                        <span class="text-xs font-black text-emerald-700 bg-emerald-50 border border-emerald-150 px-2.5 py-1 rounded-lg">Activos</span>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        >
                            <div>
                                <div class="flex items-center justify-between mb-2">
                                    <h3 class="font-extrabold text-slate-800 text-sm flex items-center gap-1.5">
                                        <span class="w-2.5 h-2.5 rounded-full shadow-3xs bg-emerald-500 border-2 border-emerald-100 animate-pulse"></span>
                                        {{ lab.nombre }}
                                    </h3>
                                    <span class="text-3xs font-semibold px-2 py-0.5 bg-slate-100 text-slate-500 rounded-full border border-slate-150 uppercase tracking-tighter">
                                        {{ lab.pabellon }}
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex justify-between items-center text-[10px] text-slate-400 font-bold">
                                    ...
                                    <span class="text-emerald-600 font-black">
                                        {{ lab.estaciones_count > 0 ? Math.round((lab.estaciones_activas_count / lab.estaciones_count) * 100) : 0 }}%
                                    </span>
                                </div>
                            </div>
                        </div>
