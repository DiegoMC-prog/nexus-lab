...
import { X, GraduationCap, Loader2 } from '@lucide/vue';
...
const emit = defineEmits<{
    ...
    (e: 'save', data: CarreraFormData): void;
}>();

const formData = ref<CarreraFormData>({
    nombre: '',
    codigo: ''
});

const isEditing = computed(() => !!props.carrera);
...
const handleSubmit = () => {
    emit('save', { ...formData.value, codigo: formData.value.codigo.toUpperCase() });
};
</script>
            ...
            <div
                ...
                <form @submit.prevent="handleSubmit" class="p-6 space-y-4">
                    <div class="space-y-1.5">
                        ...
                        <input v-model="formData.codigo" type="text" required placeholder="Ej: INF-SIS"
                            :disabled="isSaving"
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input v-model="formData.nombre" type="text" required placeholder="Ej: Ingeniería de Sistemas"
                            :disabled="isSaving"
                    ...
                    <div class="mt-6 pt-4 border-t border-gray-100 flex justify-end gap-3 bg-gray-50 -mx-6 -mb-6 p-4">
                        ...
                        <button type="submit" :disabled="isSaving"
                            ...
                            <span>{{ isSaving ? 'Guardando...' : (isEditing ? 'Guardar Cambios' : 'Crear Carrera')
                            }}</span>
                        </button>
                    </div>
                </form>
