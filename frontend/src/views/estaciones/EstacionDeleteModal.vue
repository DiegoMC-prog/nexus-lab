            ...
            <div class="bg-white rounded-xl border border-gray-100 max-w-md w-full shadow-2xl relative overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-150">
                ...
                <div class="px-6 pt-6 pb-4 flex items-start justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">Eliminar Estación</h3>
                ...
                <div class="p-6">
                    <p class="text-sm text-gray-600 leading-relaxed">
                        ¿Está absolutamente seguro de que desea eliminar la estación 
                        <span class="font-bold text-gray-900">"{{ estacion?.hostname }}"</span>? 
                        Se perderá toda su vinculación con el laboratorio asignado y dejará de recibir telemetría.
                    </p>
                </div>
                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-end gap-2.5">
                    ...
                    <button @click="emit('confirm')" :disabled="isDeleting"
                        ...
                        <span>{{ isDeleting ? 'Eliminando...' : 'Eliminar Estación' }}</span>
                    </button>
                </div>
